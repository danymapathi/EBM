			...
			<input type="text" class="input-block-level" id="card" name="card" placeholder="Your visa card number" required>
			Upload Your Bacchelor's degree
			<input type="file" class="input-block-level" id="Bacchelor" name="Bacchelor" placeholder="Upload Your Bacchelor's degree" required>
