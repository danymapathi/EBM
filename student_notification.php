        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					?>
					<a href="#" style="text-decoration: none; color: white;"><div class="alert alert-info"><strong><i class="icon-info-sign"></i> No Notifications Found</strong></div></a>
					<?php
					}
					?>
						...
						<div id="block_bg" class="block">
							...
							<a href="#" style="text-decoration: none; color: white;"><div class="alert alert-info" style=" width:93%; margin-left:auto; margin-right:auto;"><strong><i class="icon-info-sign"></i> View Notifications 65</strong></div></a>
						</div>
